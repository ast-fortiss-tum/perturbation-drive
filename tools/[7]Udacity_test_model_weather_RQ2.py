    ...
    for model_path in model_paths:
        for i in range(3,15):
                for weather in weathers:
                    ...
                    print("Testing:"+f"./output_logs/2test_weather_{model_name}/udacity_{weather}_road_{road_types_list[i]}_{i}_logs")
                    ...
                    benchmarking_obj.grid_seach(
                        ...
                        log_dir=f"./output_logs/test_weather_{model_name}/udacity_{weather}_road_{road_types_list[i]}_{i}_logs_{time}.json",
                        overwrite_logs=True,
                        image_size=(240, 320),
                        test_model=True,
                        perturb=False,
